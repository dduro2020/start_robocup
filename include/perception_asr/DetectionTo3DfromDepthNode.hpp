...
private:
  /* Se sincronizan dos callbacks, es decir, los dos mensajes del callback se sincronizan para que lleguen
  "al mismo tiempo". */
  void callback_sync(
  ...
  /* Se crean suscriptores especiales para recibir datos de imagenes. */
